...
const formatReadableTime = (isoTimestamp: string) => {
...
export default function DetailScreen() {
  ...
  const persistUpdatedTask = async (updater: (task: TodoItem) => TodoItem) => {
    ...
    const updatedSelf =
      updatedTodos.find((item) => item.id === task.id) ?? null;
    setTask(updatedSelf);
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          style={styles.headerIcon}
          onPress={() =>
            router.push({ pathname: "/addtodo", params: { id: task.id } })
          }>
      ...
      <ScrollView
        ...
        <View style={styles.timeRow}>
          ...
          <View style={styles.timeItem}>
            ...
            <Text style={styles.timeText}>
              {formatReadableTime(task.updatedAt || task.createdAt)}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.subtasksWrap}>
          ...
          {isAddingSubtask ? (
            <View style={styles.addSubtaskInputContainer}>
              ...
              />
              <TouchableOpacity
                onPress={submitNewSubtask}
                style={styles.addSubtaskSaveBtn}>
